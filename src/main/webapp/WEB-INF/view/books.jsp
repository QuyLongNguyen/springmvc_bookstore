...
<body class="bg-light">
	...
	<div class="container bg-white ">
		<div
			class=" row row-col-4 justify-content-around border border-success rounded ">
			<div
				class="col-xl-12 border pt-2 pb-2  text-white h3 bg-success rounded mb-3 ">
				<c:if test="${empty param.keyword }">
				...
				<div class="col-xl-2 ">
					...
					<div class="text-center">
						<a class="btn btn-warning mt-2"
							href="${viewDetail}/${book.bookId}" role="button">View </a>
					</div>
			...
			<div
				class="col-xl-12 pt-2 pb-2 mt-2  text-center bg-light border-bottom border-success rounded">
