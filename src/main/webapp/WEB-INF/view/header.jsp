		...
		<body>
			<div class="container-fluid bg-primary p-3">
				<div class="row">
					...
					<div class="col-xl-1 mr-n3 ml-4	"> <a href="${pageContext.request.contextPath}/home">
				...
				<div class="col-xl-1 text-white dropdown" style="padding-left:0;padding-right:0">
					...
					aria-expanded="false"> <fmt:message key="label.categories" /> </a>
				...
				<div class="col-xl-6 text-white mr-2 ">
					<form action="${pageContext.request.contextPath}/books "method="get">
						<div class="input-group ">
							<input type="text" class="form-control" placeholder=<fmt:message key="label.search_holder" />
							aria-label="Search" aria-describedby="basic-addon2" name="keyword">
							<div class="input-group-append">
								<input class="btn btn-outline-light" type="submit" value= <fmt:message key="label.search"/> ></input>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="col-xl-1 text-white dropdown mr-5" style="padding-left:0;padding-right:0;">
					...
					<div class="col-xl-1 mt-1 custom-link-blue rounded" >
						...
						<a href="${pageContext.request.contextPath}/cart" >
							...
							<a href="${pageContext.request.contextPath}/cart" class="text-white"><fmt:message key="label.cart"/></a>
							</security:authorize>
							...
							<a href="${pageContext.request.contextPath}/cart" >
								...
								<a href="${pageContext.request.contextPath}/login" class=" text-white"><fmt:message key="label.cart"/></a>
								</security:authorize>
				...
				<div class="col-xl-1 text-white dropdown" style="padding-left:0;padding-right:0">
					<a class="btn btn-primary  dropdown-toggle" href="#" role="button"
						id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <fmt:message key="label.languages" />  </a>
					<c:set value="" var="currentUrl"></c:set>
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						
						<a class="dropdown-item btn-sm" href="${currentUrl}?lang=en">English</a>
						<a class="dropdown-item btn-sm" href="${currentUrl}?lang=vi">Vietnamese</a>
