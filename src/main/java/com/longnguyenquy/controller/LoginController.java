...
public class LoginController {
	...
	public String loginGoogle(@RequestParam(required = false) String code) throws ClientProtocolException, IOException{ 
		...
		User user = googleService.buildUser(account);
		UsernamePasswordAuthenticationToken authentication = 
				new UsernamePasswordAuthenticationToken(userService.loadUserByUsername(user.getUserName()),null,userService.mapRolesToAuthorities(user.getRoles()));
